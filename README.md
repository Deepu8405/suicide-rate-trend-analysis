# Global Suicide Rate Trend Analysis 📊

This project performs an in-depth Exploratory Data Analysis (EDA) on global suicide rates to uncover patterns related to geography, gender, age groups, and socio-economic factors.
...
* **Economic Correlation:** Investigating the relationship between GDP per capita and suicide rates.
...
3. [cite_start]Open `analysis.ipynb` in Jupyter Notebook[cite: 23].
